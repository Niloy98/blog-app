...
const Footer = () => {
  return (
    <footer className="w-full border-b-gray-300 border-2 bg-white z-50 dark:bg-gray-800 dark:text-gray-200 p-5">
      <div className="max-w-7xl mx-auto px-4 md:flex md:justify-between">
        {/*  info */}
        <div className='mb-6 md:mb-0 pt-7'>
            <Link to='/' className='flex gap-3 items-center'>
              {/* <img src={Logo} alt="" className='w-32'/> */}
              <img src={Logo} alt="" className='invert w-12 h-12'/>
              <h1 className=' text-3xl font-bold'>Logo</h1>
            </Link>
            <p className='mt-2'>Share insights, tutorials, and ideas.</p>
        </div>
        ...
        <div>
          <h3 className="text-xl font-semibold">Stay With Us</h3>
